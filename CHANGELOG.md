...
- Added `spec.BackupSource.S3.ForcePathStyle` to `EtcdBackup` to force path style s3 uploads. [#2036](https://github.cogithub.com/coreos/etcd-operatorm/coreos/etcd-operator/pull/2036)
